...
function HomePage() {
  return (
    <section className="grid grid-cols-1 gap-y-13 justify-items-center items-start  mx-auto w-full max-w-7xl md:grid-cols-2 md:gap-x-4">
      <div className="bg-white border-blue-100 border-4 max-w-11/12 w-full py-3 px-4 rounded-sm md:max-w-[450px] max-h-[628px] overflow-hidden">
